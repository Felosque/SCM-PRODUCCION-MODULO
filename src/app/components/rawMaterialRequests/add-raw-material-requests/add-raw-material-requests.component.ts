...
import {RawMaterialRequestsService, RawMaterialRequestsClass} from '../rawMaterialRequests-service.service'
import {DateAdapter} from '@angular/material/core';
import { Router } from '@angular/router';
import {Productions} from '../../../productions/productions'
import {ProductionsService} from '../../../productions/productions-service.service'
...
export class AddRawMaterialRequestsComponent implements OnInit {
  ...
  save(): void{
    var rawMaterialRequests = new RawMaterialRequestsClass(this.state, this.requestDate.toLocaleDateString() + " " +this.requestDate.toLocaleTimeString(), this.numberOrder, parseInt(this.numberBatch.toString()))
